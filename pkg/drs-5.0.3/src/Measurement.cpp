 ...
 * $Id: Measurement.cpp 21273 2014-02-20 13:01:57Z ritt $
 */
...
wxString Measurement::GetStat()
{
   ...
   if (m_nMeasured == 0) {
      ...
      rms = sqrt(m_vvsum/m_nMeasured - m_vsum*m_vsum/m_nMeasured/m_nMeasured);
   }
   ...
   if (ss_isnan(m_min) || ss_isnan(m_max))
      ...
      str.Printf(wxT("%8.3lf %8.3lf %8.3lf %8.4lf %6d"), m_min, m_max, mean, rms, m_nMeasured);
   return str;
}
