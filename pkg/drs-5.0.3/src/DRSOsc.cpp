...
ConfigDialog_fb::ConfigDialog_fb( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	wxString m_rbChRangeChoices[] = { wxT("1 to 4"), wxT("5 to 8"), wxT("9 to 12"), wxT("13 to 16") };
	int m_rbChRangeNChoices = sizeof( m_rbChRangeChoices ) / sizeof( wxString );
	m_rbChRange = new wxRadioBox( this, ID_CH_RANGE, wxEmptyString, wxDefaultPosition, wxDefaultSize, m_rbChRangeNChoices, m_rbChRangeChoices, 1, wxRA_SPECIFY_ROWS );
	m_rbChRange->SetSelection( 0 );
	sbSizer511->Add( m_rbChRange, 0, wxALIGN_CENTER_HORIZONTAL, 5 );
	
	wxString m_rbChHalfChoices[] = { wxT("lower half"), wxT("upper half"), wxT("combined") };
	int m_rbChHalfNChoices = sizeof( m_rbChHalfChoices ) / sizeof( wxString );
	m_rbChHalf = new wxRadioBox( this, ID_CH_HALF, wxEmptyString, wxDefaultPosition, wxDefaultSize, m_rbChHalfNChoices, m_rbChHalfChoices, 1, wxRA_SPECIFY_ROWS );
	m_rbChHalf->SetSelection( 0 );
	sbSizer511->Add( m_rbChHalf, 0, wxALIGN_CENTER_HORIZONTAL, 5 );
	
	m_cbClkOn = new wxCheckBox( this, wxID_ANY, wxT("Connect reference clock to channel #4"), wxDefaultPosition, wxDefaultSize, 0 );
	sbSizer511->Add( m_cbClkOn, 0, wxALIGN_CENTER_VERTICAL|wxALIGN_CENTER_HORIZONTAL, 5 );
	...
	m_rbChRange->Connect( wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnChannelRange ), NULL, this );
	m_rbChHalf->Connect( wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnChannelRange ), NULL, this );
...
ConfigDialog_fb::~ConfigDialog_fb()
{
	...
	m_rbChRange->Disconnect( wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnChannelRange ), NULL, this );
	m_rbChHalf->Disconnect( wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler( ConfigDialog_fb::OnChannelRange ), NULL, this );
